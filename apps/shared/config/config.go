...
type Config struct {
	...
	AWSSQSQueueNameVideoProcessing string `env:"AWS_SQS_QUEUE_NAME_VIDEO_PROCESSING,required"`
	AWSSQSQueueNameNotification    string `env:"AWS_SQS_QUEUE_NAME_NOTIFICATION,required"`
...
func NewConfig() *Config {
	...
	return &Config{
		...
		AWSSQSQueueNameVideoProcessing: os.Getenv("AWS_SQS_QUEUE_NAME_VIDEO_PROCESSING"),
		AWSSQSQueueNameNotification:    os.Getenv("AWS_SQS_QUEUE_NAME_NOTIFICATION"),
...
func (c *Config) ValidateSQSConfig() error {
	...
	if c.AWSSQSQueueNameVideoProcessing == "" {
		return fmt.Errorf("AWS SQS video processing queue name is required")
	}

	if c.AWSSQSQueueNameNotification == "" {
		return fmt.Errorf("AWS SQS notification queue name is required")
	}
